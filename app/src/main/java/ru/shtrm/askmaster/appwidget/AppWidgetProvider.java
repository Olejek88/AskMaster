...
public class AppWidgetProvider extends android.appwidget.AppWidgetProvider {
    ...
    private static final String REFRESH_ACTION = "ru.shtrm.askmaster.appwidget.action.REFRESH";
    ...
    private RemoteViews updateWidgetListView(Context context, int id) {
        ...
        Intent tempIntent = new Intent(context, QuestionDetailsActivity.class);
